...
class FacebookProfile(models.Model):
    ...
    FACEBOOK_FIELDS = ['uid,profile_url,pic,pic_square,name,first_name,last_name,pic_big,pic_square_with_logo,affiliations,status,proxied_email']
    # all the fields are here:
    # http://wiki.developers.facebook.com/index.php/Users.getInfo
    DUMMY_FACEBOOK_INFO = {
        'uid':0,
        'pic':'/public/images/t_silhouette.jpg',
        'pic_square':'/public/images/t_silhouette.jpg',
        'profile_url': None,
        'name':'(Private)',
        'first_name':'(Private)',
        'last_name':'(Private)',
        'pic_square_with_logo':'/public/images/t_silhouette.jpg',
        'pic_big': '/public/images/t_silhouette.jpg',
        'affiliations':None,
        'status':None,
        'proxied_email':None,
    }
    ...
    def __get_picture_large_url(self):
        self.__configure_me()
        if self.__facebook_info['pic_big']:
            return self.__facebook_info['pic_big']
        else:
            return self.DUMMY_FACEBOOK_INFO['pic_big']
    picture_large_url = property(__get_picture_large_url)
    ...
    def get_friends_profiles(self,limit=settings.NUM_FRIEND_RETRIEVE_LIMIT):
        ...
        if len(friends_ids) > 0:
            ...
            if len(friends_ids) > limit:
                friends = self.__get_facebook_info(friends_ids[0:limit])
            else:
                friends = self.__get_facebook_info(friends_ids)
    ...
    def __get_facebook_friends(self):
        ...
        if fb_info_cache:
            ...
            friends = _facebook_obj.friends.get()
